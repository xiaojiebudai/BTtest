...
/**
	 ...
	 * @param listener
	 */
	protected void initTextHeadRigth(String resId, OnClickListener listener) {
		View right = findViewById(R.id.rl_head_right);
		TextView text = (TextView) findViewById(R.id.tv_head_right);
		if (right != null && text != null) {
			right.setOnClickListener(listener);
	 ...
	 * @param listener
	 */
	protected void initTextHeadRigthImg(int resId, OnClickListener listener) {
		View right = findViewById(R.id.rl_head_right);
		TextView text = (TextView) findViewById(R.id.tv_head_right);
		if (right != null && text != null) {
			right.setOnClickListener(listener);
	 ...
	 * @param listener
	 */
	protected void initTextHeadRigthImgFunc(int resId, OnClickListener listener) {
		View right = findViewById(R.id.rl_head_left);
		TextView text = (TextView) findViewById(R.id.tv_head_left);
		if (right != null && text != null) {
			right.setOnClickListener(listener);
			text.setBackgroundResource(resId);
		}
